...
allSnakes = []
player = Snake(gameField, "AI1", 0, startSpeed, enableStucking)
AISnake = Snake(gameField, "AI2", 1, startSpeed, enableStucking)
...
def thread_function2():
    ...
    while not endGame:
        ...
        player.rotate(smartAI.smartMove(gameField.getFieldWithAll(allSnakes), player.cords[-1], player.lives, player.direction, enableStucking), allSnakes)
